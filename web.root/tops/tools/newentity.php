...
require('tops/tools/starttools.php');

require_once("tops/tops_lib/db/TDBTableInfo.php");
...
//   writeClassFile('wmtasks','TWmTask');
// writeClassFile('fdsclasses','TFdsClass');
// writeClassFile('fdsassignments','TFdsAssignment');
// writeClassFile('fdsteachers','TFdsTeacher');
writeClassFile('reminders','TReminder');
    echo '<br>Done.<br>';
